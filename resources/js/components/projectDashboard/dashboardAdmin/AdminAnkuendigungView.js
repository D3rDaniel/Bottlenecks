  ...
  return (
    <div className="bg-white rounded-xl w-full h-1/3 drop-shadow-xl">
        <div className="flex flex-col h-5/6">
            ...
            <div>
                <input type="text" placeholder="Titel.." className="font-bold ml-4 mt-2 outline-none w-11/12 bg-gray-200 p-1 rounded-md drop-shadow-md placeholder-gray-600"></input><br></br>
                <textarea type="text" rows="3" className="ml-4 mt-2 outline-none w-11/12 mr-5 rounded-md drop-shadow-md bg-gray-200 pl-1"></textarea>
            </div>
        </div>
        <div className="flex justify-end items-center h-1/6">
            <div className="flex justify-center bg-blue rounded-xl h-8 w-48 mb-2 mr-2">
                ...
                <button className="text-white hover:font-bold">Veröffentlichen</button>
            </div>
        </div>
    </div>
  )
